...
export default function AddLikePopUp(pop) {
    

    return (
        <section className={`${pop ? "opa" : ""} bottom-0 left-0 z-50 fixed m-8 p-6 flex flex-nowrap bg-white shadow-[0_1px_5px_0px_rgba(0,0,0,0.2)] rounded-2xl overflow-hidden`}>
            ...
            <div className={`${popp.className} pl-10`}>
                ...
                <p className="text-[#888888] text-[13px] leading-7">You can see your favorites in the <Link href="/" className="text-[#e65540]">Favorites</Link> section.</p>
            </div>
